/*
 * Chroma-Hash : A secure visualization of password field input
				...
				var trigger = function () {
					...
					if ($input.val().length == 1) {
						chromaHashesForElement(this).each(function (i) {
							...
							$("#loginform .dashicons-visibility").css({color:"#fff"});
						});
...
// INIT
	$("input:password").chromaHash({bars: chvars.bars, salt: chvars.salt, minimum: chvars.minimum});
});