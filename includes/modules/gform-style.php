...
function cc_caboodle_gform_style() {
	...
	wp_add_inline_style( 'caboodle-gform', '.gform_wrapper {
		--gform-border-color: ' . esc_attr( cc_caboodle( "gform_border_color", '#c6c6c6' ) ) . ';
		--gform-border-color-hover: ' . esc_attr( cc_caboodle( "gform_border_color_hover", '#969696' ) ) . ';
		--gform-border-color-focus: ' . esc_attr( cc_caboodle( "gform_border_color_focus", '#e91e63' ) ) . ';
	}' );
