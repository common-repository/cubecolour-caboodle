 ...
 *
 */
function cc_pll_custom_flag( $flag, $code ) {
...
add_filter( 'pll_custom_flag', 'cc_pll_custom_flag', 10, 2 );
...
*
*/
function cc_polylang_flags_style(){
...
add_action( 'wp_enqueue_scripts', 'cc_polylang_flags_style', 20);