...
*
*/
function cc_scrolltop_enqueue(){
	wp_enqueue_style( 'scrolltop', CC_CABOODLE_PLUGIN_URL . 'css/scrolltop.css' , false, CC_CABOODLE_PLUGIN_VERSION );
	wp_enqueue_script( 'scrolltop', CC_CABOODLE_PLUGIN_URL . 'js/scrolltop.js', false, CC_CABOODLE_PLUGIN_VERSION );
...
add_action( 'wp_enqueue_scripts', 'cc_scrolltop_enqueue', 20);
...
*
*/
function cc_scrolltop() {
	?>
	<a class="scrolltop"></a>
	<?php
}
add_action( 'wp_footer', 'cc_scrolltop', 1 );